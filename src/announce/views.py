...
from announce.forms import CreateBlogPostForm, UpdateBlogPostForm
...
def create_blog_view(request):
    ...
    return render(request, "announce/create_blog.html")
...
def detail_blog_view(request, slug):
    ...
    return render(request, 'announce/detail_blog.html', context)
...
def edit_blog_view(request, slug):
	...
	context['form'] = form
	return render(request, 'announce/edit_blog.html', context)


def get_blog_queryset2(query=None):
	queryset = []
